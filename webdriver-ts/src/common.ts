...
export let frameworks = [
    // f("angular-v1.5.8"),
    // f("angular-v1.5.8-nokey"),
    // f("angular-v1.5.8-indexkey"),
    // f("angular-v2.2.1"),
    // f("angular-v2.2.1-nokey"),
    // f("angular-v2.2.1-indexkey"),
    ...
    f("react-v15.4.0"),
    f("react-v15.4.0-delegate"),
    // f("react-v15.4.0-nokey"),
    // f("react-v15.4.0-indexkey"),
